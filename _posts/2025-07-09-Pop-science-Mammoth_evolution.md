...
thumbnail: assets/img/Vignette_Mammoth.jpg
images:
  compare: true
  slider: true
---
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <figure class="text-center">
      {% include figure.liquid path="assets/img/FIG1_Mammoth.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
      <figcaption class="mt-2">
        Figure 1. Woolly Mammoth herd (Image credit: Movie Alpha)
      </figcaption>
    </figure>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <figure class="text-center">
      {% include figure.liquid path="assets/img/FIG2_Mammoth.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
      <figcaption class="mt-2">
        Figure 2. Best-fitting admixture graph model for mammoth evolution (Image modified from https://doi.org/10.1038/s41586-021-03224-9)
      </figcaption>
    </figure>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <figure class="text-center">
      {% include figure.liquid path="assets/img/FIG3_Mammoth.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
      <figcaption class="mt-2">
        Figure 3. Admixture illustration between *M. trogontherii* and *M. primigenius*.
      </figcaption>
    </figure>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <figure class="text-center">
      {% include figure.liquid path="assets/img/FIG4_Mammoth.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
      <figcaption class="mt-2">
        Figure 4. Illustration of the interaction between mammoths and humans (Image modified from Chauvet and Rouffignac paintings)
      </figcaption>
    </figure>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <figure class="text-center">
      {% include figure.liquid path="assets/img/FIG5_Mammoth.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
      <figcaption class="mt-2">
        Figure 5. Categories of GO terms significantly enriched in woolly mammoths and Asian elephants (Image modified from https://doi.org/10.1016/j.cub.2023.03.084)
      </figcaption>
    </figure>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <figure class="text-center">
      {% include figure.liquid path="assets/img/FIG7_Mammoth.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
      <figcaption class="mt-2">
        Figure 7. The temporal distribution of ancient DNA studies (Image from https://doi.org/10.1126/science.adh7943)
      </figcaption>
    </figure>
  </div>
</div>
